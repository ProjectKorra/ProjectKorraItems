	...
	public class GrapplingHookTask extends BukkitRunnable {
		...
		public void run() {
			...
			if (state == State.START) {
				 ...
				 * directly.
				 */
				playAnimation(player.getEyeLocation().add(0, -0.5, 0), currentLoc, 1, (float) 0.1,
						(float) red, (float) green, (float) blue);
				BlockIterator iter = new BlockIterator(currentLoc.getWorld(),
						currentLoc.toVector(), direction, 0, (int) speed + 1);
