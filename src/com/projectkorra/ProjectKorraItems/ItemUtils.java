...
public class ItemUtils {
	...
	/**
	 * Returns a list of the players armor and in hand item, ONLY if
	 * the item is usable for the specific player. If the item has the
	 * "HoldOnly", "WearOnly", or "RequireElement" stat, then this
	 * method may ignore some items.
	...
	/**
	 * Checks if an item has a usable amount of charges,
	 * or doesn't require charges at all.
